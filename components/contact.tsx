...
export function ContactForm() {
  ...
  const socials = [
    {
      title: "twitter",
      href: "https://twitter.com/tsunai_xyz",
      icon: (
    ...
    {
      title: "github",
      href: "https://github.com/tsunai-xyz",
      icon: (
    ...
    {
      title: "linkedin",
      href: "https://linkedin.com/company/tsunai-xyz",
      icon: (
                      ...
                      <FormControl>
                        <div className="mt-2">
                          <input
                            id="name"
                            type="name"
                            placeholder="Tsunai Labs"
                            className="block w-full bg-white dark:bg-neutral-900 px-4 rounded-md border-0 py-1.5 text-black placeholder:text-gray-400 focus:ring-2 focus:ring-neutral-400 focus:outline-none sm:text-sm sm:leading-6 dark:text-white"
                            {...field}
                          />
                        </div>
                      </FormControl>
