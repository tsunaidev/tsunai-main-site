    ...
    >
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl font-bold">
          Building Together: Our Project Roadmap
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-xl">
          We believe in building in public and fostering a true community-driven project. 
          Our fair launch approach and DAO governance structure ensures every voice matters 
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-5 md:pt-10 px-4 sm:px-6 lg:px-8"
          >
